...
class Controller extends AppController {
	protected function init() {
		$sql= "SELECT cabin_mileage, cabin_change_date FROM filter WHERE car_id = {$_SESSION['car_id']} AND cabin_change_date IS NOT NULL";
		...
		$sql_air= "SELECT air_mileage, air_change_date FROM filter WHERE car_id = {$_SESSION['car_id']} AND air_change_date IS NOT NULL";
